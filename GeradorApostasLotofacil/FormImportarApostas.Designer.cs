namespace GeradorApostasLotofacil
{
    partial class FormImportarApostas
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelTop.Controls.Add(label_dadosApostas);
            panelTop.Controls.Add(btn_importarApostas);
            panelTop.Dock = DockStyle.Top;
            panelTop.Location = new Point(0, 0);
            panelTop.Name = "panelTop";
            panelTop.Padding = new Padding(15);
            panelTop.Size = new Size(965, 100);
            // 
            // label1
            // 
            ...
            label1.Name = "label1";
            label1.Text = "📥 Importar Resultados Oficiais";
            // 
            // label_dadosApostas
            // 
            label_dadosApostas.AutoSize = true;
            label_dadosApostas.Font = new Font("Segoe UI", 10F);
            label_dadosApostas.ForeColor = Color.FromArgb(180, 180, 200);
            label_dadosApostas.Location = new Point(18, 55);
            label_dadosApostas.Name = "label_dadosApostas";
            label_dadosApostas.Text = "Carregando informações do sorteio...";
            // 
            // btn_importarApostas
            // 
            btn_importarApostas.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            btn_importarApostas.BackColor = Color.FromArgb(255, 152, 0);
            btn_importarApostas.FlatAppearance.BorderSize = 0;
            btn_importarApostas.FlatStyle = FlatStyle.Flat;
            btn_importarApostas.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            btn_importarApostas.ForeColor = Color.White;
            btn_importarApostas.Location = new Point(780, 15);
            btn_importarApostas.Name = "btn_importarApostas";
            btn_importarApostas.Size = new Size(165, 38);
            btn_importarApostas.Text = "⬇️ Importar Agora";
            btn_importarApostas.Cursor = Cursors.Hand;
            ...
            dgv_listaApostas.Columns.AddRange(new DataGridViewColumn[] { colData, PrimeiroNumero, SegundoNumero, TerceiroNumero, QuartoNumero, QuintoNumero, SextoNumero, SetimoNumero, OitavoNumero, NonoNumero, DecimoNumero, DecimoPrimeiroNumero, DecimoSegundoNumero, DecimoTerceiroNumero, DecimoQuartoNumero, DecimoQuintoNumero });
            ...
            dgv_listaApostas.Location = new Point(0, 100);
